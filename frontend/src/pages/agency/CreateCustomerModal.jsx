...
export default function CreateCustomerModal({ onClose, onCreated }) {
  ...
  const loadFeatures = async () => {
    try {
      const data = await api.get('/api/v1/agency/features');
  ...
  const handleCreate = async () => {
    setLoading(true);
    try {
      const result = await api.post('/api/v1/agency/customers', {
        name: form.name,
        slug: form.slug,
        email: form.email,
        phone: form.phone,
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <div className="flex items-center">
                      <span className="text-gray-400 text-sm mr-1">app.buildpro.com/</span>
                      <input
                        type="text"
                        value={form.slug}
