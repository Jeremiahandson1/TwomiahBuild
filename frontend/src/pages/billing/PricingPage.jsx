...
export default function PricingPage() {
  ...
  const loadPricing = async () => {
    try {
      const data = await api.get('/api/v1/billing/pricing');
      setPricing(data);
    } catch (error) {
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
          ...
          <div className="max-w-4xl mx-auto flex items-center justify-between">
            <div>
              ...
              <p className="text-orange-100">
                Own BuildPro forever with our lifetime license. No monthly fees, self-hosted option available.
              </p>
            </div>
        ...
        <div className="mt-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <AddonCard
              name="White Label"
              description="Remove BuildPro branding, use your own"
              monthlyPrice={99}
              oneTimePrice={990}
            />
            <AddonCard
