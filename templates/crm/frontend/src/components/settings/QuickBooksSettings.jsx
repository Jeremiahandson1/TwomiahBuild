        ...
        <>
          ...
          <div className="bg-white rounded-xl border p-6">
            ...
            <p className="text-sm text-gray-500 mb-4">
              Push your BuildPro data to QuickBooks
            </p>
          ...
          <div className="bg-white rounded-xl border p-6">
            ...
            <p className="text-sm text-gray-500 mb-4">
              Pull data from QuickBooks into BuildPro
            </p>
      ...
      {!status?.connected && (
        <div className="bg-blue-50 rounded-xl p-6">
          ...
          <ol className="list-decimal list-inside space-y-2 text-sm text-blue-800">
            ...
            <li>Authorize BuildPro to access your data</li>
            <li>You'll be redirected back here once connected</li>
          </ol>
          <p className="mt-4 text-xs text-blue-600">
            BuildPro will only access customer and invoice data. Your financial reports and 
