        ...
        {activeTab === 'branding' && (
          <div className="settings-panel">
            ...
            <div className="form-group" style={{ marginTop: '28px' }}>
              ...
              <p style={{ color: 'var(--admin-text-secondary)', fontSize: '13px', marginBottom: '16px', marginTop: 0 }}>
                Changes take effect on next page load. These colors are applied site-wide via CSS variables.
              </p>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                <div>
                  <label style={{ fontSize: '13px', marginBottom: '6px', display: 'block' }}>Primary Color</label>
                ...
                <div>
                  <label style={{ fontSize: '13px', marginBottom: '6px', display: 'block' }}>Secondary Color</label>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                    <input
                      type="color"
                ...
                <div>
                  <label style={{ fontSize: '13px', marginBottom: '6px', display: 'block' }}>Accent Color</label>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                    <input
                      type="color"
                ...
                <div>
                  <label style={{ fontSize: '13px', marginBottom: '6px', display: 'block' }}>Background Tint</label>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                    <input
                      type="color"
              ...
              <div style={{ marginTop: '14px', display: 'flex', gap: '10px', alignItems: 'center' }}>
                ...
                {[
                  ...
                  <div key={c.key} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '4px' }}>
                    ...
                    <span style={{ fontSize: '10px', color: 'var(--admin-text-muted)' }}>{c.label}</span>
                  </div>
                ))}
              </div>
            </div>
