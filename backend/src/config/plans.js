/**
 * PLAN_FEATURES — Single Source of Truth
 *
 * Previously duplicated in auth.js, featureGate.js, and pricing.js.
 * All three now import from here. Do NOT copy this object anywhere else.
 *
 * To add a feature to a plan:
 *   1. Add the feature key here
 *   2. It automatically flows to featureGate.js and pricing.js
 */
...
export const PLAN_HIERARCHY = ['starter', 'pro', 'business', 'construction', 'enterprise'];

export const CORE_FEATURES = [
  'contacts', 'jobs', 'scheduling', 'quotes', 'invoices', 'dashboard',
];

export default { PLAN_FEATURES, PLAN_LIMITS, PLAN_HIERARCHY, CORE_FEATURES };
